...
<!-- app/views/bus/detail.php -->
<div class="container">
    <h3 class="mt-3">Pemesanan Kursi Bus <?= $data['bus']['kode_bus']; ?></h3>
    <form action="<?= BASE_URL; ?>/index.php?url=tiket/pesan" method="POST" id="formKursi">
        ...
        <p class="mt-3">Jumlah kursi kosong: <strong><?= $totalSeats - count($bookedSeats); ?></strong></p>
        <button type="submit" class="btn btn-primary mt-1">Pesan Sekarang</button>
    </form>
</div>
